...
public class ViajeIT {
    ...
    public void testViajeFamiliar() throws ParseException {
        ...
        assertEquals(new SimpleDateFormat("dd/MM/yyyy").parse("05/05/2019"), viaje.getFechaEntrada());
    ...
    public void testViajeIncentivo() throws ParseException {
        ...
        assertEquals(new SimpleDateFormat("dd/MM/yyyy").parse("09/06/2019"), viaje.getFechaEntrada());
    ...
    public void testViajeIndividual() throws ParseException {
        ...
        assertEquals(new SimpleDateFormat("dd/MM/yyyy").parse("12/07/2019"), viaje.getFechaEntrada());
